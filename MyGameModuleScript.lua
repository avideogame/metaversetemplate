...
aModule.MyConfig["MyGame"] = {
	...
	MyLightingSkycube = {
		MyCubemap = {
			b = "http://www.roblox.com/asset/?id=12345678901",
	...
	MyPlace  = {	
		aId = 12345678901,
		aLatitude = 22.2934485,
		aLongitude = 114.1727475,
		MyLabel = {
			aEnglish = "Metaverse Asia",
			aChinese = "元宇宙 亞洲",
		},
	},
	MyPlaceFacility  = {	
	...
	MySpringGroup = {
		...
		MyType = {
			...
			MySpringEast = {
				aName = "MySpringEast",
				aPosition = Vector3.new((10*1.0),(0.5*1.0),0),
				MyLabel = {
					aEnglish = "East",
					aChinese = "東",
				},
